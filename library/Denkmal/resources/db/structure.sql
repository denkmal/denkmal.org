...
CREATE TABLE `denkmal_model_venuealias` (
  ...
  UNIQUE KEY `name` (`name`),
  KEY `venueId` (`venueId`),
  CONSTRAINT `denkmal_model_venuealias__venue` FOREIGN KEY (`venueId`) REFERENCES `denkmal_model_venue` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `denkmal_message` (
  ...
  KEY `venueId` (`venueId`),
  KEY `created` (`created`),
  CONSTRAINT `denkmal_message__venue` FOREIGN KEY (`venueId`) REFERENCES `denkmal_model_venue` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
