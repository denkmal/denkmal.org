...
return function (CM_Model_Language $language) {
    ...
    $language->setTranslation('.meta.description', '{$siteName} wird von Locals gemacht. Entdecke das Nachtleben deiner Stadt und verpasse keine erstklassige Party mehr!');
