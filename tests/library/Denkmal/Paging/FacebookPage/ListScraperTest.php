...
class Denkmal_Paging_FacebookPage_ListScraperTest extends CMTest_TestCase {
    ...
    public function testGetItems() {
        ...
        (new Denkmal_Paging_FacebookPage_ListScraper($region2))->add($facebookPage1);
        ...
        $this->assertEquals([$facebookPage3, $facebookPage1], new Denkmal_Paging_FacebookPage_ListScraper($region2));
        ...
        (new Denkmal_Paging_FacebookPage_ListScraper())->remove($facebookPage2);
        $this->assertEquals([], new Denkmal_Paging_FacebookPage_ListScraper($region1));
    }
