...
class Denkmal_Paging_Venue_GeoPointTest extends CMTest_TestCase {
    ...
    public function testGetItems() {
        ...
        $venue3 = Denkmal_Model_Venue::create('Foo 3', false, false, null, null, new CM_Geo_Point(47.5526076, 7.572782));
        $venue3->setSuspended(true);
        $venue4 = Denkmal_Model_Venue::create('Foo 4', false, false, null, null, new CM_Geo_Point(47.4700548, 7.6924664));
